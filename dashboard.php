...
<div class="container">
	<div class="sixteen columns">
		...
		<!-- Logo -->
		<div id="logo">
		<h1><a href="indeex.php"><img  src="images/logo2.png" alt="Work Scout" /></a></h1>
		</div>
...
<div id="dashboard">
	...
	?>
			...
			<!-- Copyrights -->
			<div class="col-md-12">
				<div class="copyrights">Copyright &copy;<script>document.write(new Date().getFullYear());</script> by <a href=" ">Disign Patterns</a>. All Rights Reserved.</div>
			</div>
		</div>
