					...
					<div class="sixteen columns">
						...
						<div class="search-container">
							...
							<form class='form-sample' method='POST' action=''>
								<input type="button" style='color:white' readonly class="ico-01" value="Find Skill"
									name='title' placeholder="Find Skill" />

								<ul class="float-right"><br> <br> <br>
									<li>

										<a href="dashboard-add-job.php"> <input type="button" style='color:white'
												readonly class="ico-01" value="Click Here To Add A Skill" name='title'
							...
							<!-- <form class='form-sample' method='POST' action=''> -->
							<input type="text" class="ico-01" name='title' v-model="title" placeholder="job title"
								value="" />
							...
							<button style='background-color:green' class="button centered" type='submit'
								v-on:click="seachtitleandlocation()" name='firstsearch' id='firstsearch'><i
...
================================================== -->
		...
		?>
							...
							var indeex = new Vue({
								...
								methods: {
									...
									getAllLogSheets() {
										...
										axios
											.get("http://localhost/Ibiraka/getskills.php")
											.then(res => {
									...
									seachtitleandlocation() {
										...
										axios
											.get('http://localhost/Ibiraka/getskillsbysearch.php', {
												params: {
													title: this.title,
					...
					<form class='form-sample' method='POST' action=''>
						...
						<button style='background-color:green' class="button centered" type='submit' name='moreskills'
							id='moreskills'><i class="fa fa-plus-circle"></i>Show More Skills</button>
					</form>
				...
				<div class="testimonial-carousel testimonials">
					...
					<div class="fw-carousel-review">
						<div class="testimonial-box">
							<div class="testimonial">"Ikiraka has tapped the trend towards freelance labor and gig-based
					...
					<div class="fw-carousel-review">
						<div class="testimonial-box">
							<div class="testimonial">"Ikiraka uses innovative technology to learn about my job
		...
		<div id="footer">
			...
			<div class="container">
				...
				<div class="seven columns">
					<h4>About</h4>
					<p>An online platform that connects clients with service providers of a broad range of needs for
						such brief but necessary tasks mostly in the informal sector.</p>
